...
public class PostsExtractionTest {
    ...
    public void test003() {
        response = given()
                ...
                .get("/posts?page=1&per_page=25")
                .then().statusCode(200);
        List<String> recordBody = response.extract().path("findAll{it.id == 38967}.body");
        System.out.println("------------------StartingTest---------------------------");
    ...
    public void test006() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The  title of all records whose user_id = 2250463 is : " + title);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test007() {
        response = given()
                ...
                .get("/posts?page=1&per_page=25")
                .then().statusCode(200);
        List<String> recordBody = response.extract().path("findAll{it.id == 38970}.body");
        System.out.println("------------------StartingTest---------------------------");
